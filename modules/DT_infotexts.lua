...
function update_ReputationData(event, unit)
  if GetWatchedFactionInfo() then
    ...
    ReputationData.dText = format('%s%s|r: %0.1f%% [%s%s|r]', ReputationData.color, dUI:ReadableString(ReputationData.name, 10), ReputationData.percent, ReputationData.color, ReputationData.isParagon and 'P+' or abbreviateStanding(ReputationData.standingLabel))
